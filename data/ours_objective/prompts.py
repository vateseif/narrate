...
{
  "tasks": ["move gripper 0.1m above coffee pod", "move gripper to coffee_pod", "close_gripper()", "move gripper 0.1m upwards", "move gripper above coffe_machine", "open_gripper()"]
}

objects = ['blue block', 'yellow block', 'mug']
# Query: stack the blue block on the yellow block.
{
  "tasks": ["move gripper 0.1m above the blue block", "move gripper to blue block", "close_gripper()", "move gripper upwards at a height higher than yellow block", "move the gripper 0.1m above the yellow block", "open_gripper()"]
}


objects = ['plate', 'fork', 'glass']
# Query: Order the kitchen objects flat on the table in the x-y plane.
{
  "tasks": ["move gripper 0.1m above fork", "move gripper to fork", "close_gripper()", "move gripper 0.1m upwards", "move gripper 0.1m above the left side of the plate", "open_gripper()", "move gripper 0.1m upwards, "move gripper above the glass", "move gripper to the glass", "close_gripper()", "move gripper 0.1m upwards", "move gripper 0.1m above the position in front of the plate", "open_gripper()"]
}
...
# Query: make a stack of cubes on top of the green cube.
{
  "tasks": ["move gripper to the blue_cube and avoid collisions with green_cube, orange_cube, red_cube","close_gripper()","move gripper above the green_cube and avoid collisions with orange_cube, red_cube","open_gripper()","move gripper to the orange_cube and avoid collisions with blue_cube, green_cube, red_cube","close_gripper()","move gripper above the stack formed by blue_cube and green_cube and avoid collisions with red_cube","open_gripper()","move gripper to the red_cube and avoid collisions with blue_cube, green_cube, orange_cube","close_gripper()","move gripper above the stack formed by orange_cube, blue_cube, and green_cube","open_gripper()"]
}
